<template>
    ...
    <div class="min-h-screen bg-white flex flex-col">
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="flex items-center space-x-3">
            <Link
              ...
              class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition shadow-sm hover:shadow text-sm font-medium">
              Dashboard
            </Link>
            <template v-else>
              <Link :href="route('login')" class="px-4 py-2 text-gray-700 hover:text-emerald-600 transition text-sm font-medium">
                Sign In
              </Link>
              <Link :href="route('register')" class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition shadow-sm hover:shadow text-sm font-medium">
                Get Started
              </Link>
            </template>
  
            <!-- Mobile Menu Button -->
            <button @click="mobileMenuOpen = !mobileMenuOpen" class="md:hidden text-gray-500 hover:text-emerald-600">
      ...
      <!-- Enhanced Footer (Copied directly from your template) -->
              ...
              <div class="lg:col-span-5 space-y-6">
                ...
                <div class="group">
                  <div class="flex items-center space-x-3 mb-6">
                    <div class="relative">
                      <div class="w-12 h-12 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-emerald-500/25 transition-all duration-300">
...
import WhatsAppFloat from '@/Components/WhatsAppFloat.vue';
  ...
  export default {
    ...
    // Optional: Close mobile menu if route changes (good UX)
    watch: {
      '$page.url'() {
  ...
  /* Note: The .animate-blob class and animation delays are used in the CTA section of your homepage,
     which is now part of the specific page component. You might need to move those styles there or
     ensure they are globally available. For now, I'm leaving them out of this layout file's scope. */
  </style>
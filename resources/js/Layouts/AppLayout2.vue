<template>
  <div class="min-h-screen bg-white flex flex-col">
    ...
    <header class="w-full sticky top-0 bg-white/80 backdrop-blur-md z-50 border-b border-gray-100">
    <div class="container mx-auto px-4 sm:px-6 py-3 max-w-6xl">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div class="lg:col-span-5 space-y-6">
              ...
              <div class="flex space-x-4">
                <a href="https://x.com/TestoriaNG" target="_blank" class="group relative p-3 bg-gray-800/50 hover:bg-gradient-to-br hover:from-emerald-600 hover:to-teal-600 rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-emerald-500/25">
                ...
                <a href="https://www.linkedin.com/company/Testoria NG" target="_blank" class="group relative p-3 bg-gray-800/50 hover:bg-gradient-to-br hover:from-blue-600 hover:to-blue-700 rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/25">
                  <svg class="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-5">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div class="flex items-center space-x-4 text-sm text-gray-400">
                <span>&copy; 2025 Testoria Nigeria. All rights reserved.</span>

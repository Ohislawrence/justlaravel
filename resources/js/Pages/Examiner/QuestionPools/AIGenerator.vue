                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-100">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Empty State -->
                            <div v-else-if="!showPreview" class="flex items-center justify-center min-h-[300px] border-2 border-dashed border-gray-300 rounded-lg">
                                <div class="text-center">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                    </svg>
                                    <h3 class="mt-2 text-sm font-medium text-gray-900">No questions generated yet</h3>
                                    <p class="mt-1 text-sm text-gray-500">Fill out the form and click "Generate Questions" to get started.</p>
                                </div>
                            </div>
                        </div>
                    </div>

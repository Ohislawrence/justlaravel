  ...
  export default {
    ...
    methods: {
      ...
      submitForm() {
        ...
        if (this.removeImage && this.editing) {
          this.form.remove_image = true;
        }

        this.form.post(route('examiner.pools.questions.store', this.pool.id), {
        preserveScroll: true,
        onSuccess: () => {
      ...
      cancel() {
        this.$inertia.visit(route('examiner.pools.questions.create'));
      },
    },
  };
</script>

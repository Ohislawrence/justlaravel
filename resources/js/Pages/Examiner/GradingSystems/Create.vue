...
const form = useForm({
    ...
    description: '',
    grade_ranges: [
        { min: 0, max: 49, grade: 'F', points: 0, interpretation: 'Fail' },
        { min: 50, max: 100, grade: 'P', points: null, interpretation: 'Pass' }
    ]
});
...
const submit = () => {
    form.post(route('examiner.grading-systems.store'));
};
</script>

<template>
    <AppLayout title="Create Grading System">
        <template #header>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="flex justify-end pt-4">
                                    ...
                                    >
                                        ...
                                        <span v-else>Create Grading System</span>
                                    </button>
                                </div>
                            </div>
                        </form>

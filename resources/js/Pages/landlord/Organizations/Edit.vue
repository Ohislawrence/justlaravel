...
const submitForm = () => {
    form.put(route('landlord.organizations.update', props.organization.id));
};
</script>

<template>
    <AppLayout :title="`Edit Organization - ${organization.name}`">
        <template #header>
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form @submit.prevent="submitForm">
                            ...
                            <div class="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
                                <Link 
                                    :href="route('landlord.organizations.show', organization.id)"

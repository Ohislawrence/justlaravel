...
<template>
      ...
      <section id="blog" class="bg-gradient-to-b from-white to-gray-50 py-16 sm:py-20">
        <div class="container mx-auto px-4 sm:px-6">
          ...
          <div class="max-w-6xl mx-auto mb-12 sm:mb-16">
            <div class="group bg-white rounded-3xl shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 hover:border-emerald-200 overflow-hidden">
              <div class="grid lg:grid-cols-2 gap-0">
                ...
                <div class="p-6 sm:p-8 lg:p-12">
                  <div class="flex items-center gap-3 mb-4">
                    <span class="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-medium">Education</span>
                    <span class="text-sm text-gray-500">5 min read • Dec 15, 2023</span>
                  </div>
                  <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 group-hover:text-emerald-600 transition-colors">
                    How Nigerian Schools Are Using AI to Improve Student Assessment
                  </h3>
                  <p class="text-gray-600 mb-6 leading-relaxed">
                    Discover how forward-thinking Nigerian schools are leveraging artificial intelligence to create more personalized, effective assessments that adapt to each student's learning pace and style.
                  </p>
                  <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                      <div class="w-10 h-10 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center">
                        <span class="text-white text-sm font-semibold">AO</span>
                      </div>
                      <div>
                        <div class="text-sm font-medium text-gray-900">Adunni Okoye</div>
                        <div class="text-xs text-gray-500">Education Technology Expert</div>
                      </div>
                    </div>
                    <a href="#" class="inline-flex items-center text-emerald-600 hover:text-emerald-700 font-medium text-sm transition-colors group">
                      Read More
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            <!-- Blog Post 1 -->
            <article class="group bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-emerald-200 overflow-hidden">
              <div class="aspect-video bg-gradient-to-br from-emerald-50 to-teal-50 p-6 flex items-center justify-center relative overflow-hidden">
                <div class="absolute inset-0 opacity-10">
              ...
              <div class="p-6">
                <div class="flex items-center gap-2 mb-3">
                  <span class="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">Tips</span>
                  <span class="text-xs text-gray-500">Dec 12, 2023</span>
                </div>
                <h3 class="text-lg font-semibold text-gray-900 mb-3 group-hover:text-emerald-600 transition-colors">
                  10 Effective Quiz Strategies for Nigerian Classrooms
                </h3>
                <p class="text-sm text-gray-600 mb-4 line-clamp-3">
                  Learn practical strategies to create engaging quizzes that work in Nigerian educational settings, from primary schools to universities.
                </p>
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <div class="w-6 h-6 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
                      <span class="text-white text-xs font-semibold">KA</span>
                    </div>
                    <span class="text-xs text-gray-600">Kemi Adebayo</span>
                  </div>
            ...
            <!-- Blog Post 2 -->
            <article class="group bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-emerald-200 overflow-hidden">
              <div class="aspect-video bg-gradient-to-br from-purple-50 to-pink-50 p-6 flex items-center justify-center relative overflow-hidden">
                <div class="absolute inset-0 opacity-10">
                  <div class="absolute top-2 left-2 w-16 h-16 bg-purple-500 rounded-full blur-xl"></div>
                  <div class="absolute bottom-2 right-2 w-20 h-20 bg-pink-400 rounded-full blur-xl"></div>
                </div>
                <div class="relative">
              ...
              <div class="p-6">
                <div class="flex items-center gap-2 mb-3">
                  <span class="px-2 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">Analytics</span>
                  <span class="text-xs text-gray-500">Dec 10, 2023</span>
                </div>
                <h3 class="text-lg font-semibold text-gray-900 mb-3 group-hover:text-emerald-600 transition-colors">
                  Understanding Student Performance Data: A Teacher's Guide
                </h3>
                <p class="text-sm text-gray-600 mb-4 line-clamp-3">
                  Master the art of interpreting quiz analytics to identify learning gaps and improve your teaching effectiveness in Nigerian schools.
                </p>
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <div class="w-6 h-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
                      <span class="text-white text-xs font-semibold">IO</span>
                    </div>
                    <span class="text-xs text-gray-600">Ibrahim Osman</span>
                  </div>
            ...
            <!-- Blog Post 3 -->
            <article class="group bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-emerald-200 overflow-hidden">
              <div class="aspect-video bg-gradient-to-br from-orange-50 to-red-50 p-6 flex items-center justify-center relative overflow-hidden">
                <div class="absolute inset-0 opacity-10">
                  <div class="absolute top-2 left-2 w-16 h-16 bg-orange-500 rounded-full blur-xl"></div>
                  <div class="absolute bottom-2 right-2 w-20 h-20 bg-red-400 rounded-full blur-xl"></div>
                </div>
                <div class="relative">
                  <div class="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl flex items-center justify-center shadow-md">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="p-6">
                <div class="flex items-center gap-2 mb-3">
                  <span class="px-2 py-1 bg-orange-100 text-orange-700 rounded-full text-xs font-medium">Mobile</span>
                  <span class="text-xs text-gray-500">Dec 8, 2023</span>
                </div>
                <h3 class="text-lg font-semibold text-gray-900 mb-3 group-hover:text-emerald-600 transition-colors">
                  Mobile Learning in Nigeria: Opportunities and Challenges
                </h3>
                <p class="text-sm text-gray-600 mb-4 line-clamp-3">
                  Explore how mobile technology is transforming education across Nigeria, from urban centers to rural communities.
                </p>
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xs text-gray-600">Folake Nwosu</span>
                  </div>
          ...
          <div class="text-center mt-12">
            <a href="#" class="inline-flex items-center px-8 py-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-all duration-200 hover:scale-[1.02] font-medium shadow-lg hover:shadow-xl">
              View All Articles
  ...
  import AppLayout2 from '@/Layouts/AppLayout2.vue'; // Adjust path as needed
  
  export default {
    components: {
      Link,
      AppLayout2 // Register the layout component
    }
  }
  </script>
